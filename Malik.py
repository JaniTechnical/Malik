...
\x1b[0;33m║WELCOME TO MY TOOLS  [🔥 JANI 906🔥].  ║

\x1b[0;33m║       #TOOL AUTHOR [JANI 906]  PAKISTANI KING'S. ║
...
\x1b[0;33m║#YOUTUBE : https://youtube.com/channel/UCRKqrw7avFVBcEBNIYqTheQ.  ║

\x1b[0;33m║#FACEBOOK : NAME [ALI TAHIR].       ║

\x1b[0;33m║#GITHUB : https://github.com/JANI9906.   ║
...
def menu():
	...
	elif Jani == "1" or NAIM == "01":

		publik()

		method()

	elif Jani== "2" or NAIM == "02":

		follower()

		method()

	elif Jani== "3" or  NAIM == "03":

		massal()

		method()

	elif Jani== "4" or Nops == "04":
	...
	elif Jani== "5" or Jani== "05":

		setting_ua()

	elif Jani== "0" or Jani== "00":
